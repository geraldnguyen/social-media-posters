...
class TestDailymotionAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api = DailymotionAPI(self.client_id, self.client_secret, self.refresh_token)
    ...
    def test_authenticate(self, mock_post):
        ...
        mock_response.text = '{"access_token": "test_access_token", "refresh_token": "new_refresh_token"}'
        ...
        self.assertEqual(args[0], "https://api.dailymotion.com/oauth/token")
...
class TestPostToDailymotion(unittest.TestCase):
    ...
    def test_post_to_dailymotion_success(self, mock_getsize, mock_exists, mock_api_class, 
        ...
        mock_get_required.side_effect = lambda var: {
            ...
            "DAILYMOTION_REFRESH_TOKEN": "refresh",
