...
from .social_media_utils import process_templated_content_if_needed


class TestProcessTemplatedContent(unittest.TestCase):
    ...
    def test_builtin_curr_date(self):
        ...
        with patch('common.social_media_utils.datetime') as mock_datetime:
